...
class settingsManagerTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertTrue($this->object->fetch('data2/date3') == 4);       
    }
    ...
    public function testGetFail() {
        $this->assertTrue($this->object->fetch('fail') == 4);
    }
    ...
    public function testSet()
    {
        ...
        $this->object->setValue('data','changed');                
        $this->assertTrue($this->object->fetch('data') == 'changed');
    }
    ...
    public function testSetFailWithException() {
        $this->object->setValue('data','change again');                
        $this->assertTrue($this->object->fetch('data') == 'change again');
    }
    ...
    {
        $this->assertTrue($this->object->pathExists('data2/date3'));
    }
    
    /**
     * @covers SettingsManager\settingsManager::exists     
     */
    public function testNotPathExists()
    {
        $this->assertTrue($this->object->pathExists('noData') === false);
    }
